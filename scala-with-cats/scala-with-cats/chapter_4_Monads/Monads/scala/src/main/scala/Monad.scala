...
object Monad {
  ...
  implicit val listMonad: Monad[MyList] =
    new Monad[MyList] {
      ...
      def flatMap[A, B](value: MyList[A])(func: A => MyList[B]): MyList[B] =
        value match {
          case Nil         => Nil
  ...
  implicit val maybeMonad: Monad[Maybe] =
    new Monad[Maybe] {
      ...
      def flatMap[A, B](value: Maybe[A])(func: A => Maybe[B]): Maybe[B] =
        value match {
  ...
  implicit val treeMonad: Monad[Tree] =
    new Monad[Tree] {
      ...
      def flatMap[A, B](a: Tree[A])(func: A => Tree[B]): Tree[B] =
        a match {
          case Leaf(a)      => func(a)
